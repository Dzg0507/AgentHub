...
def main():
    ...
    parser.add_argument(
        "--server-host", default="127.0.0.1", help="FastAPI server host"
    )
    parser.add_argument(
        "--server-port", type=int, default=8000, help="FastAPI server port"
    )
    parser.add_argument(
        "--streamlit-port", type=int, default=8501, help="Streamlit UI port"
    )
    parser.add_argument(
        "--no-monitor", action="store_true", help="Disable process monitoring"
    )
    parser.add_argument(
        "--server-only", action="store_true", help="Start only the FastAPI server"
    )
    parser.add_argument(
        "--streamlit-only", action="store_true", help="Start only the Streamlit UI"
    )
